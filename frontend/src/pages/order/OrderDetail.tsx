...
function OrderDetail() {
  ...
  const historyOrders = useOrder(orderCode).data;
  // Truyen ma don hang r lay du lieu ve
          ...
          <div className="order-detail-user-info">
            <div className="address-container">
              ...
              <div className="order-detail-address-detail">
                ...
                <span className="text order-detail-address">
                  Địa chỉ: {historyOrders.address}
                </span>
                <span className="text order-detail-phone">
            ...
            <div className="shipping-type-container">
              ...
              <div className="order-detail-shipping-type-wrapper">
                <span className="text order-detail-shipping-type">
                  {historyOrders.shippingMethod}
                </span>
                <span className="text order-detail-shipping-date">
                  {historyOrders.receiveDate}
                </span>
                <span className="text order-detail-shipping-fee">
            ...
            <div className="payment-type-container">
              ...
              <div className="order-detail-payment-type-wrapper">
                <span className="text order-detail-payment-type">
